...
/**
 * This class randomly selects a true/false question from a predefined list.
 * It inherits from the TFQuest class.
 * 
 * @author Jacob Zheng
 */
...
public class randTFQuestion extends TFQuest {
    ...
    // A 2D array that stores questions, their correct answers, and feedback
    ...
    /**
     * This method randomly selects a question from the list and sets
     * the question, answer, and feedback fields (inherited from TFQuest).
     */
    @Override
    public void setStuff() {
        Random random = new Random(); // Create a Random object
        int index = random.nextInt(questionlist.length); // Get a random index from the array
        this.question =  questionlist[index][0]; // Set the question text
        this.answer = questionlist[index][1]; // Set the correct answer (True/False)
        this.feedback = questionlist[index][2]; // Set the feedback or explanation
    }
}
